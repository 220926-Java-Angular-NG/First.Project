...
/**
 * The type Flash card controller.
 */
public class FlashCardController {
    ...
    /**
     * Instantiates a new Flash card controller.
     */
    ...
    public Handler updateFlashCard = context -> {
       ...
       //creating a model of our flashcard using the json from the request body
        ...
        // Assigning the card that was just created above to the updated card
       // in order to get from the db when running the update method -
